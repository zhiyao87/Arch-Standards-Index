...
**按专业方向的完整明细（369 条，14 组）已拆到独立文件，避免把 README 撑到 160 KB+、拖慢 GitHub 网页首屏渲染：**

👉 [SH-NOTICES.md — 各专业方向明细（点击查看）](SH-NOTICES.md)
...
├── SH-NOTICES.md              规范批准/发布通知完整明细（脚本生成；入库，README 第五节链过来）
